...
To not tire the reindeer, Santa Claus wants to leave the maximum number of gifts by making the least number of trips possible.
...
Create a program that tells him the highest sum of gifts that he could distribute, taking into account the maximum number of gifts and the maximum number of cities he can visit. 
...
If it is not possible to make any trips that satisfies everything, the result should be 0.
### More examples:
```js
